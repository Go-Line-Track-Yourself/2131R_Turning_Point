...
//intake buttons
namespace intake{
  okapi::ControllerButton FastButton = ellisonsController[okapi::ControllerDigital::right];
...
namespace lift{
  okapi::ControllerButton UpButton = ellisonsController[okapi::ControllerDigital::left];
  okapi::ControllerButton DownButton = ellisonsController[okapi::ControllerDigital::down];
  okapi::ControllerButton MaxButton = ellisonsController[okapi::ControllerDigital::L1];
  okapi::ControllerButton MinButton = ellisonsController[okapi::ControllerDigital::L2];
}
